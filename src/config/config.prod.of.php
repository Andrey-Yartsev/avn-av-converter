    ...
    'presets' => [
        'of' => [
            'video' => [
                ...
                'outputFormat' => 'mp4',
                'command'      => "-i {INPUTFILE} {OUTPUTFILE} -c:v libx264 -preset slow -crf 23 -profile:v baseline -level 3.0 -b:v 250k -maxrate 250k -bufsize 500k -movflags +faststart -pix_fmt yuv420p -c:a libfdk_aac -b:a 128k"
            ]
        ],
    ]
];