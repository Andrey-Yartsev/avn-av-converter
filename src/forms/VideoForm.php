...
class VideoForm extends Form
{
    ...
    public function processLocalFile($inputFile)
    {
        ...
        return $this->isDelay ? Process::createQueue($this->callback, $fileUrl, $this->preset, FileHelper::TYPE_VIDEO) : $driver->processVideo($fileUrl, $this->callback);
    }
    ...
    public function processExternalFile()
    {
        ...
        return $this->isDelay ? Process::createQueue($this->callback, $this->filePath, $this->preset, FileHelper::TYPE_VIDEO) : $driver->processVideo($this->filePath, $this->callback);
    }
